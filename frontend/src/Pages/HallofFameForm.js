...
function HallOfFameForm() {
    ...
    const handleSubmit=async (e)=>{
        ...
        if(studentId==="" || companyName==="" || batch==="" || branch==="" || ctcOffered==="" || contact_info==="")
        {
            if(studentId==="")
            {
                setIdError(true);
    ...
    //     await axios.post(BASE_URL+"/studentform",{
    //         studentId,
    //         companyName,
    //         linkToApply,
    //         logoLink,
    ...
    //     setBond(0);
    //     alert(`Company with Id ${StudentId} successfully added`);
    // }
    alert("submitted")
        ...
        <div>
            ...
            <div className={`${style.form} ` }  onSubmit={handleSubmit}>
              ...
              <div className={`${style.label}`}>
                ...
                <input   className={`${style.input}`} value={student_name} type="text" id="student_name" name="student_name" onChange={(e) => setstudent_name(e.target.value)} /><br />
            </div>
...
<div className={`${style.label}`}>
                <label    htmlFor="batch">LinkedIn profile of Student: </label>&nbsp;&nbsp;
